...
"use strict";
eval("\r\nvar __awaiter = (this && this.__awaiter) || function (thisArg, _arguments, P, generator) {\r\n    return new (P || (P = Promise))(function (resolve, reject) {\r\n        function fulfilled(value) { try { step(generator.next(value)); } catch (e) { reject(e); } }\r\n        function rejected(value) { try { step(generator[\"throw\"](value)); } catch (e) { reject(e); } }\r\n        function step(result) { result.done ? resolve(result.value) : new P(function (resolve) { resolve(result.value); }).then(fulfilled, rejected); }\r\n        step((generator = generator.apply(thisArg, _arguments || [])).next());\r\n    });\r\n};\r\nObject.defineProperty(exports, \"__esModule\", { value: true });\r\nconst naver_config_1 = __webpack_require__(/*! ~configs/secret/naver.config */ \"./src/configs/secret/naver.config.ts\");\r\nconst naverCtrl = (req, res) => {\r\n    (function () {\r\n        return __awaiter(this, void 0, void 0, function* () {\r\n            try {\r\n                const url = `https://nid.naver.com/oauth2.0/authorize?client_id=${naver_config_1.default.client_id}&response_type=code&redirect_uri=${naver_config_1.default.redirect_uri}&state=123`;\r\n                res.redirect(url);\r\n            }\r\n            catch (err) {\r\n                console.log(err);\r\n                res.status(500).json(JSON.stringify({}));\r\n            }\r\n        });\r\n    })();\r\n};\r\nexports.default = naverCtrl;\r\n\n\n//# sourceURL=webpack:///./src/api/auth/socialCtrls/naverCtrl.ts?");
